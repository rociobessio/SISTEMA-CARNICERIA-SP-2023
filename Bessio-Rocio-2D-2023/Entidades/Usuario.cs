...
namespace Entidades
{
    public class Usuario
    {
        ...
        public int IDPersona { get { return this._idPersona; } set { this._idPersona = value; } }
        #endregion
        ...
        public Usuario(string email,string contrasenia,bool esCliente,int idPersona,int idCliente)
